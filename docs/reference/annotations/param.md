...
> If you need to describe a parameter that can be used within a query string, use the [`@api-queryparam`](reference/annotations/queryparam.md) annotation.
...
And then you can just reference the token as part of [`@api-param`](reference/annotations/param.md):
